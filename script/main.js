...
const App = new Vue({
  ...
  data: {
    ...
    appkey: 'BC-19bc115d3da14a85b1cdd1e0aa8bda71', // GoEasy应用appkey，替换成你的appkey

    // leancloud-realtime 添加以下变量，appId、appKey、server这几个值去leancloud控制台>设置>应用凭证里面找
    chatRoom: null,
    appId: 'AKiS6SIPNsWRtty4x9ulz1TB-gzGzoHsz',
    appKey: 'hUHrTp3nFhuFDXVpnNRlnViL',
    server: 'https://akis6sip.lc-cn-n1-shared.com', // REST API 服务器地址
  },
  methods: {
    randomString(length) {
      let str = ''
  ...
  created() {
    ...
    this.videoList.push('https://5glrs.blob.core.windows.net/rongqi/【高清MP4电影www.ttbtdytt.com】星际穿越.IMAX版.Interstellar.2014.BD720p.国英双语.特效中英双字.mp4?sv=2020-08-04&ss=bqtf&srt=sco&sp=rwdlacuptfx&se=2022-06-04T11:22:01Z&sig=%2Bbgi4EqV64upDKWzBp%2F9%2BXwE1GYt58QkxLZGLyfQ%2B8I%3D&_=1654312927469');
  ...
  mounted() {
    ...
    var roomId = this.getParam("id")?this.getParam("id"):'626b889320c1d66ed93b6144'
